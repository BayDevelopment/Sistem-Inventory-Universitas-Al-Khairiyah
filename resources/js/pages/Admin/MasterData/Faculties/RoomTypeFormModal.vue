...
watch(
    ...
    (roomType) => {
        if (roomType) {
            ...
            console.log("DATA EDIT JENIS RUANGAN:", roomType);
        ...
        >
            ...
            >
                <div>
                    ...
                    >
                        Kelola kategori atau jenis ruangan yang tersedia
                    </p>
                </div>
                ...
                <div>
                    <div class="mb-1 flex items-center justify-between">
                        ...
                        <button
                            type="button"
                            @click="generateSlug"
                            class="text-[10px] font-medium text-[#f53003] hover:underline dark:text-[#FF4433]"
                        >
                            Generate otomatis
                        </button>
                    </div>
                    ...
                    >
                        Digunakan sebagai identitas URL/internal jenis ruangan.
                    </p>
                </div>
