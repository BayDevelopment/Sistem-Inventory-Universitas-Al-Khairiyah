...
<head>
    ...
    <meta name="description"
        content="{{ $description ?? 'Sistem Inventory Universitas Al-Khairiyah — kelola dan pantau peminjaman inventaris kampus secara online dengan mudah dan aman.' }}">
    ...
    <meta property="og:title"
        content="{{ $title ?? config('app.name', 'Sistem Inventory') }} - Universitas Al-Khairiyah">
    <meta property="og:description"
        content="{{ $description ?? 'Kelola dan pantau peminjaman inventaris kampus dengan sistem autentikasi modern.' }}">
